...
def plot_learning_curve(logfile_dir, result_lists):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(os.path.join(logfile_dir, 'training_accuracy.png'))
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(os.path.join(logfile_dir, 'validation_accuracy.png'))
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(os.path.join(logfile_dir, 'training_loss.png'))
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(os.path.join(logfile_dir, 'validation_loss.png'))
    plt.close()
